        ...
        <form className="space-y-6">
          ...
          <div>
            <input
              type="email"
              placeholder="E-POSTA"
              className="w-full px-4 py-4 font-[450] border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent text-black placeholder-gray-400 placeholder:text-[11px]  placeholder:tracking-widest"
              required
            />
          </div>
